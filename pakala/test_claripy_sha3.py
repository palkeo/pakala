...
class TestSha3Support(unittest.TestCase):
    ...
    def test_solver_arithmetics(self):
        ...
        self.assertTrue(s.satisfiable(
            extra_constraints=[Sha3(in1) + 1 == Sha3(in2) + 1]))
        self.assertFalse(s.satisfiable(
            extra_constraints=[Sha3(in1) + 1 == Sha3(in2) + 2]))
        self.assertFalse(s.satisfiable(
            extra_constraints=[Sha3(in1) + 1 == Sha3(in2) + 2]))
    ...
    def test_solver_one_var(self):
        ...
        self.assertTrue(s.satisfiable(extra_constraints=[Sha3(in1 + 1) + 2 == Sha3(0) + 2]))
    ...
    def test_solver_recursive(self):
        ...
        self.assertTrue(s.satisfiable(extra_constraints=[Sha3(Sha3(in1)) == Sha3(Sha3(0))]))
    ...
    def test_env_replace_merge(self):
        ...
        self.assertFalse(old_state.solver.satisfiable(extra_constraints=[old_env.value == 5]))
        ...
        self.assertTrue(new_state.solver.satisfiable(extra_constraints=[old_env.value == 5]))
